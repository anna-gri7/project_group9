import{a as p,i as c,A as j,S as E,N as S,P as x,R}from"./assets/vendor-DScGXjsP.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function i(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=i(a);fetch(a.href,o)}})();p.defaults.baseURL="https://furniture-store-v2.b.goit.study/api";async function q(){try{const{data:e}=await p.get("/categories");return e}catch(e){return c.show({message:`Помилка при завантажені категорій: ${e}`,color:"red",position:"topRight"}),[]}}async function P(e=1,t=null){try{let i={page:e,limit:8};t&&(i.category=t);const{data:s}=await p.get("/furnitures",{params:i});return s}catch(i){return c.show({message:`Помилка при завантажені товарів: ${i}`,color:"red",position:"topRight"}),{results:[],totalPages:0}}}let m=0;function b(){m++;const e=document.getElementById("loader");e&&e.classList.remove("hidden")}function y(){if(m--,m<=0){m=0;const e=document.getElementById("loader");e&&e.classList.add("hidden")}}const r="/project_group9/",h=document.querySelector(".categories"),k=document.querySelector(".items"),d=document.querySelector(".load-more-btn"),B=8;let u=1,w=null;const M={"66504a50a1b2c3d4e5f6a7c0":{normal:`${r}img/categories-img/hallway-furniture.jpg`,retina:`${r}img/categories-img/hallway-furniture-2x.jpg`},"66504a50a1b2c3d4e5f6a7bd":{normal:`${r}img/categories-img/kitchens.jpg`,retina:`${r}img/categories-img/kitchens-2x.jpg`},"66504a50a1b2c3d4e5f6a7c2":{normal:`${r}img/categories-img/garden-furniture.jpg`,retina:`${r}img/categories-img/garden-furniture-2x.jpg`},"66504a50a1b2c3d4e5f6a7bb":{normal:`${r}img/categories-img/tables.jpg`,retina:`${r}img/categories-img/tables-2x.jpg`},"66504a50a1b2c3d4e5f6a7b8":{normal:`${r}img/categories-img/sofa.jpg`,retina:`${r}img/categories-img/sofa-2x.jpg`},"66504a50a1b2c3d4e5f6a7be":{normal:`${r}img/categories-img/childrens-furniture.jpg`,retina:`${r}img/categories-img/childrens-furniture-2x.jpg`},"66504a50a1b2c3d4e5f6a7c3":{normal:`${r}img/categories-img/decor.jpg`,retina:`${r}img/categories-img/decor-2x.jpg`},"66504a50a1b2c3d4e5f6a7c1":{normal:`${r}img/categories-img/bathroom.jpg`,retina:`${r}img/categories-img/bathroom-2x.jpg`},"66504a50a1b2c3d4e5f6a7bf":{normal:`${r}img/categories-img/office.jpg`,retina:`${r}img/categories-img/office-2x.jpg`},"66504a50a1b2c3d4e5f6a7b9":{normal:`${r}img/categories-img/wardrobe.jpg`,retina:`${r}img/categories-img/wardrobe-2x.jpg`},"66504a50a1b2c3d4e5f6a7ba":{normal:`${r}img/categories-img/bed.jpg`,retina:`${r}img/categories-img/bed-2x.jpg`},"66504a50a1b2c3d4e5f6a7bc":{normal:`${r}img/categories-img/chairs.jpg`,retina:`${r}img/categories-img/chairs-2x.jpg`}};function T(e){const t=M[e._id];return`
    <li 
      data-id="${e._id}"
      class="category-item"
      style="
